package com.hussam.matricball.utills;
...
import com.hussam.matricball.utills.Network.AuthenticationInterceptor;
...
public class UrlController {
    ...
    private static OkHttpClient okHttpClient = new OkHttpClient.Builder()
        ...
        private static String IP_ADDRESS = "https://merneadan.000webhostapp.com";//Enter You Ip_Address here here
    private static String Purchase_code = "12366205-50ef-4ae9-a798-c3e9052aee5e";//Enter the purchase code here
    private static String Custom_Security = "hussam";//Enter the Custom Security code here
