...
public class ClothesMensActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Products").child("ClothesMens");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_clothes_mens);



        recyclerView = findViewById(R.id.recycler_menu_clothes);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder productViewHolder, int i, @NonNull final Products products) {
                ...
                productViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ClothesMensActivity.this, ClothesDetailsActivity.class);
