...
public class HairMensActivity extends AppCompatActivity {
   ...
   // private AppBarConfiguration mAppBarConfiguration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Products").child("HairMens");

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hair_mens);

        recyclerView = findViewById(R.id.recycler_menu_hair);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder productViewHolder, int i, @NonNull final Products products) {
                ...
                productViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(HairMensActivity.this, HairDetailsActivity.class);
