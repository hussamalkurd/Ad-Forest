...
public class WatchesMensActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Products").child("WatchesMens");

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_watches_mens);

        recyclerView = findViewById(R.id.recycler_menu_watches);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder productViewHolder, int i, @NonNull final Products products) {
                ...
                productViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(WatchesMensActivity.this, WatchesDetailsActivity.class);
