...
public class AddProductsActivity extends AppCompatActivity {
    ...
    private String CategoryName, Description, Price, Pname,Cname, saveCurrentDate, saveCurrentTime, productRandomKey, downloadImageUrl;


    private Button AddNewProductButton;
    private ImageView InputProductImage;
    private EditText InputProductName, InputProductDescription, InputProductPrice,CurrentCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductRef = FirebaseDatabase.getInstance().getReference().child("Products").child(Cname);
        AddNewProductButton = findViewById(R.id.add_new_product);
        //CurrentCategory = findViewById(R.id.categories_name);
    ...
    private void ValidateProductData() {
       ...
       // Cname = CurrentCategory.getText().toString();
    ...
    private void StoreProductImageInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AddProductsActivity.this, "Image Uploaded Successfully ...", Toast.LENGTH_SHORT).show();
    ...
    private void SaveProductInfoToDatabase() {
        ...
        ProductRef.child(productRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Intent intent = new Intent(AddProductsActivity.this, AdminCategoryActivity.class);
