...
import com.hussam.matricball.Config.Config;
...
public class PayPalActivity extends AppCompatActivity {
    ...
    private static final int PAYPAL_REQUSET_CODE = 7171;
    ...
    private void processPayment() {
        ...
        PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(String.valueOf(amount))
                ,"USD","Donate For Matric Ball App", PayPalPayment.PAYMENT_INTENT_SALE);
